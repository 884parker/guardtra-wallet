      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="bg-muted/30 border border-border rounded-xl p-4">
          ...
          <ul className="space-y-1.5 text-xs text-muted-foreground">
            <li className="flex items-start gap-2"><span className="text-recovery mt-0.5">•</span>When you revoke a paused transaction, funds are rerouted to your primary recovery address</li>
