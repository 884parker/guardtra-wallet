  ...
  return (
    <div className="md:ml-56 space-y-5">
      ...
      <div className="vault-glow bg-card border border-vault/30 rounded-2xl p-6">
        ...
        <p className="text-xs text-muted-foreground">All outgoing transfers include a mandatory {lockHours}-hour security pause.</p>
      </div>
      ...
      <div className="bg-muted/50 border border-border rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-2 text-xs text-muted-foreground">
            ...
            <span className="bg-guard/10 text-guard px-2 py-0.5 rounded">Pause ({lockHours}h)</span>
            <ArrowRight className="w-3 h-3" />
